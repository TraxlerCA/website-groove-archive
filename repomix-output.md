...
Generated by Repomix on: 2025-08-30 08:42:02
...
*/
const ROW_COLS =
  "grid grid-cols-[1.5rem_minmax(0,1fr)_clamp(7rem,28vw,220px)_clamp(5rem,18vw,88px)] items-center gap-3";
...
export function IconButton({title,onClick,ariaLabel,children}:{title:string;onClick?:()=>void;ariaLabel?:string;children:ReactNode;}) {
  return (
    <button title={title} aria-label={ariaLabel||title} onClick={onClick}
      className="w-11 h-11 grid place-items-center rounded-full border border-neutral-300 bg-white hover:bg-neutral-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-300">
      {children}
    </button>
  );
}
