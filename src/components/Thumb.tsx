    ...
    return (
      <div className="relative w-full aspect-video overflow-hidden">
        <Image
          ...
          className={`object-cover transition-transform duration-300 group-hover:scale-[1.03] ${loaded?"blur-0":"blur-md"}`}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-80"/>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-12 h-12 rounded-full bg-[var(--sodium)]/20 border border-[var(--sodium)]/60 grid place-items-center backdrop-blur-sm group-hover:shadow-[0_0_22px_rgba(183,255,46,0.3)] transition">
            <PlayIcon/>
          </div>
        </div>
      </div>
