  ...
  return (
    <header className="pt-8">
      <style>{`
        ...
        .wmk::before,.wmk::after{
          content:"";position:absolute;left:50%;top:50%;border-radius:9999px;pointer-events:none;opacity:0;filter:blur(22px)
        }
        /* extra wide soft base */
        .wmk::before{
          width:200%;height:300%;
          transform:translate(-50%,-50%) scale(.94);
          background:radial-gradient(closest-side,rgba(37,99,235,.48),transparent 74%);
        }
        /* bright core */
        .wmk::after{
          width:150%;height:200%;
          transform:translate(-50%,-50%) scale(.94);
          background:radial-gradient(closest-side,rgba(37,99,235,.76),transparent 72%);
        }
        ...
        @keyframes heartbeat{
          ...
          25%{transform:translate(-50%,-50%) scale(1.14)}
          55%{transform:translate(-50%,-50%) scale(1.01)}
        }
      `}</style>
